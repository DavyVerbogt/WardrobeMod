...
public class MenuHatLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public MenuHatLayer(RenderLayerParent<T, M> renderer, EntityModelSet modelSet) {
        super(renderer);
    ...
    protected ResourceLocation getTextureLocation(T entity, String layer) {
        return switch (LayersConfig.LAYER_CHOICE.get()) {
            case TOP_HAT -> TopHatTexture = new ResourceLocation(Wardrobe.MOD_ID,
                    ...
                    case TOP_TOP_TOP_HAT-> TopHatTexture = new ResourceLocation(Wardrobe.MOD_ID,
                    "textures/player/hats/toptoptophat/top_top_top_hat" + layer + ".png");
        };
